...
function Cita() {
    ...
    const obtenerEspecialidades = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/especialidades`);
    ...
    const obtenerHorariosDisponibles = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/citas/horarios-disponibles`, {
                params: {
                    fech: fecha,
    ...
    const fnGuardarCita = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${process.env.REACT_APP_API_URL}/api/citas/guardar`,
                {
                    fech: fecha,
                    hora: hora,
